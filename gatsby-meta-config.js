module.exports = {
  title: `Hagyeong-Log`,
  description: `Grow and Research Log from hagyeong`,
  ...
  author: {
    ...
    social: {
      instagram: `https://www.instagram.com/hagyeongleee/`,
      github: `https://github.com/hagyeonglee`, // `https://github.com/hagyeonglee`,
      linkedIn: `https://www.linkedin.com/in/hagyeonglee/`, // `https://www.linkedin.com/in/hagyeong-lee-1b342520b/`,
      email: `hagyeongleee@gmail.com`, // 
      CurriculumVitae: `https://www.overleaf.com/read/mwkpfjnjzjbt#0ae993`,
  ...
  about: {
    timestamps: [
      ...
      {
        date: '2024. 05. 02 ',
        activity: 'A new text-guided image compression algorithm, TACO 🌮 is Accepted at ICML 🇦🇹!!',
        links: {
      ...
      },
      {
        ...
        activity: 'POSTECH EE - Winter Research Intern',
        links: {
          post: '',
          github: '',
          demo: '',
      ...
      },
      {
        ...
        activity: 'KIST Post-Silicon Semiconductor Institute - Research Intern',
        links: {
          post: '',
          github: '',
          demo: '',
      ...
      },
      {
        ...
        activity: 'Ewha CSE Capstone - Project Leader ',
        links: {
          post: '',
      ...
      },
      {
        ...
        activity: 'Yonsei Severance for Clinical Imaging Data Science (CCIDS) - Research Intern',
        links: {
          post: 'https://doi.org/10.1016/j.joen.2022.04.007',
          github: '',
          demo: '',
          file: '',
        },
      },
      {
        ...
        activity: 'Ewha Graphics Lab. - Summer Research Intern',
        links: {
      ...
      },
      {
        ...
        activity: 'Ewha Womans University @CSE',
        links: {
          post: '',
          github: '',
          demo: '',
    ...
    projects: [
      ...
      // },
      {
        title: 'KIST Post-Silicon Semiconductor Institute - Undergraduate Research Program ',
        description:
      ...
      },
      {
        ...
        techStack: ['ML', 'Audio processing', 'Entrepreneurship'],
        thumbnailUrl: '',
        links: {
          post: '',
          github: '',
      ...
      // },
      {
        ...
        links: {
          ...
          googlePlay: 'https://tooning.io/?gad_source=1&gclid=CjwKCAiAiaC-BhBEEiwAjY99qP_jqJm1iDBn2zwtdbo1DkBnY0pi7NcwBw7t_QfR7HBmn4ESOwle_xoC4KUQAvD_BwE',
          appStore: '',
          demo: 'https://tooning.io/magic',//'http://stage.toonsquare.co/ai/emotion/kor?tester',
          instagram: '',
          file: '',
        },
      },
      {
        title: 'Google Developer Student Club Lead - Ewha',
      ...
      {
        title: 'NAEK YEHS Representitive - Ewha',
        description: 'Young Engineers Honor Society (YEHS) is a student organization that aims to foster the growth of young engineers and to promote the development of the engineering field.',
        techStack: ['Communication Skill', 'ML'],
        thumbnailUrl: '',
        links: {
          post: 'https://www.naekyehs.org/',
          github: '',
          googlePlay: '',
          appStore: '',
          demo: '',
